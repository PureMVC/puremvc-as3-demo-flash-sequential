...
package org.puremvc.as3.multicore.demos.sequential.controller 
{
	...
	public class ThirdAsyncCommand extends AsyncCommand
	{
		/** 
		...
		override public function execute ( note:INotification ) : void
		{
			...
			var logMessage:String = "STARTING THIRD ASYNC COMMAND...";
		...
		{	
			...
			var logMessage:String = "THIRD ASYNC COMMAND COMPLETE";
			sendNotification( ApplicationFacade.LOG_OUTPUT, logMessage );
